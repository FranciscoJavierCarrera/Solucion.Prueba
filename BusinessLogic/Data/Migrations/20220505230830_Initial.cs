        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumeroIdentificacion = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    Nombre = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    ApellidoP = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    ApellidoM = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    Direcion = table.Column<string>(type: "nvarchar(254)", maxLength: 254, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Descripcion = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsuarioMod = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumeroCuenta = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    FechaApertura = table.Column<DateTime>(type: "datetime2", nullable: false),
                    FechaUltimoMov = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
